...
class StatusUpdatesControllerTest < ActionController::TestCase
  ...
  test "should create status_update" do
    assert_difference('StatusUpdate.count') do
      post :create, status_update: { content: @status_update.content, location: @status_update.location, update_time: @status_update.update_time }
    end
  ...
  test "should update status_update" do
    put :update, id: @status_update, status_update: { content: @status_update.content, location: @status_update.location, update_time: @status_update.update_time }
    assert_redirected_to status_update_path(assigns(:status_update))
  end
